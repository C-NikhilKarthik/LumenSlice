...
QMenu::item:selected { background: #16b8c9; }
...
QPushButton#accent { background: #16b8c9; color: #ffffff; border: none; font-weight: 600; }
QPushButton#accent:hover { background: #2cd2e0; }
QPushButton#accent:pressed { background: #0f96a3; }
QPushButton#accent:disabled { background: #1d3c40; color: #6f9ba0; }
...
QCheckBox::indicator:checked, QRadioButton::indicator:checked {
    background: #16b8c9; border-color: #16b8c9; }
)QSS";
